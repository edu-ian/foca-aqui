...
// The marker for "Como funciona" starts at {/* Feature Section 1: Como funciona o Pomodoro */}
// and ends right before {/* Feature Section 2: To-Do List integrada */}
...
const footerStartMarker = "{/* CTA Footer Section */}";
...
if (idx1 !== -1 && idx2 !== -1 && idxSobre !== -1 && idxFooterStart !== -1) {
  ...
  // Change saiba mais scrollTo
  newSource = newSource.replace(/getElementById\('como-funciona'\)/g, "getElementById('sobre')");
